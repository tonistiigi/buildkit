...
type CacheOptions struct {
	// ExportRef is deprecated in favor or the new Exports since BuildKit v0.4.0.
	// When ExportRef is set, the solver appends
	// {.Type = "registry", .Attrs = ExportAttrs.add("ref", ExportRef)}
	// to Exports for compatibility.
	ExportRef string `protobuf:"bytes,1,opt,name=ExportRef,proto3" json:"ExportRef,omitempty"`
	// ImportRefs is deprecated in favor or the new Imports since BuildKit v0.4.0.
	// When ImportRefs is set, the solver appends
	// {.Type = "registry", .Attrs = {"ref": importRef}}
	// for each of the ImportRefs entry to Imports for compatibility.
	ImportRefs []string `protobuf:"bytes,2,rep,name=ImportRefs" json:"ImportRefs,omitempty"`
	// ExportAttrs is deprecated since BuildKit v0.4.0.
	// See the description of ExportRef.
	...
	Exports []*CacheOptionsEntry `protobuf:"bytes,4,rep,name=Exports" json:"Exports,omitempty"`
	// Imports was introduced in BuildKit v0.4.0.
	Imports []*CacheOptionsEntry `protobuf:"bytes,5,rep,name=Imports" json:"Imports,omitempty"`
}
...
type CacheOptionsEntry struct {
	// Type is either "registry" or "local"
	Type string `protobuf:"bytes,1,opt,name=Type,proto3" json:"Type,omitempty"`
	// Attrs supported by all cache exporters:
	// * mode=(min|max)
	// Attrs supported by "registry" cache exporter and importer:
	// * ref=example.com:5000/foo/bar
	// Attrs supported by "local" cache exporter and importer:
	// * store=path/to/dir
...
func (*CacheOptionsEntry) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{6} }
...
type SolveResponse struct {
	...
	CacheExporterResponse map[string]string `protobuf:"bytes,2,rep,name=CacheExporterResponse" json:"CacheExporterResponse,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *SolveResponse) Reset()                    { *m = SolveResponse{} }
func (m *SolveResponse) String() string            { return proto.CompactTextString(m) }
func (*SolveResponse) ProtoMessage()               {}
func (*SolveResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{7} }
...
func (m *SolveResponse) GetCacheExporterResponse() map[string]string {
	if m != nil {
		return m.CacheExporterResponse
	}
	return nil
}
...
func (*StatusRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{8} }
...
func (*StatusResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{9} }
...
func (*Vertex) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{10} }
...
func (*VertexStatus) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{11} }
...
func (*VertexLog) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{12} }
...
func (*BytesMessage) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{13} }
...
func (*ListWorkersRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{14} }
...
func (*ListWorkersResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{15} }
...
func (m *SolveResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CacheExporterResponse) > 0 {
		for k, _ := range m.CacheExporterResponse {
			dAtA[i] = 0x12
			i++
			v := m.CacheExporterResponse[k]
			mapSize := 1 + len(k) + sovControl(uint64(len(k))) + 1 + len(v) + sovControl(uint64(len(v)))
			i = encodeVarintControl(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
func (m *SolveResponse) Size() (n int) {
	...
	if len(m.CacheExporterResponse) > 0 {
		for k, v := range m.CacheExporterResponse {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovControl(uint64(len(k))) + 1 + len(v) + sovControl(uint64(len(v)))
			n += mapEntrySize + 1 + sovControl(uint64(mapEntrySize))
...
func (m *SolveResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CacheExporterResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CacheExporterResponse == nil {
				m.CacheExporterResponse = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.CacheExporterResponse[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipControl(dAtA[iNdEx:])
...
var fileDescriptorControl = []byte{
	...
	,
}
