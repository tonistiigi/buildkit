...
type BuildFunc func(ctx context.Context, platform *ocispecs.Platform) (client.Reference, *image.Image, error)

func (bc *BuildConfig) Build(ctx context.Context, fn BuildFunc) (*ResultBuilder, error) {
