...
type SolveRequest struct {
	...
	// ImportCacheRefs is deprecated in favor or the new Imports since BuildKit v0.4.0.
	// When ImportCacheRefs is set, the solver appends
	// {.Type = "registry", .Attrs = {"ref": importCacheRef}}
	// for each of the ImportCacheRefs entry to CacheImports for compatibility.
	...
	CacheImports []*CacheOptionsEntry `protobuf:"bytes,12,rep,name=CacheImports" json:"CacheImports,omitempty"`
}
...
func (*CacheOptionsEntry) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{7} }
...
func (*SolveResponse) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{8} }
...
func (*ReadFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{9} }
...
func (*FileRange) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{10} }
...
func (*ReadFileResponse) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{11} }
...
func (*ReadDirRequest) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{12} }
...
func (*ReadDirResponse) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{13} }
...
func (*StatFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{14} }
...
func (*StatFileResponse) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{15} }
...
func (*PingRequest) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{16} }
...
func (*PongResponse) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{17} }
...
var fileDescriptorGateway = []byte{
	...
	,
}
