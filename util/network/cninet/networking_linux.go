...
type CNIProvider struct {
	CNIHandle   cni.CNI
	networkOpts network.NetworkOpts
}

// InitProvider instantiate CNIProvider object
func InitProvider(networkOpts network.NetworkOpts) (network.Provider, error) {
	return &CNIProvider{networkOpts: networkOpts}, nil
}

//NewInterface creates CNI interface
func (p CNIProvider) NewInterface() (network.Interface, error) {
...
// Release resources
func (p CNIProvider) Release(network.Interface) error {
	return nil
}
